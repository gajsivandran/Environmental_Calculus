...
- I like to run very very long distances, still working on why
...
![Figure: Calculus as the mathematical language of change](images/change2.png){fig.alt="Image of Charles Darwin alongside a quote that reads, 'It is not the strongest of the species that survives, nor the most intelligent that survives. It is the one that is most adaptable to change.' The quote is displayed next to a portrait of Darwin against a muted green background." style="width:400px; margin:10px;"}
...
For an appointment check my calendar link.
...
Ask me anything - what's on your mind - need clarification on any of the things we've talked about?
<div class="writein tall"></div>
:::
...
Let's have a look at this while watching Usain Bolt run the 100m in 9.69s
...
<div class="writein"></div>
5) Now if we calculate the instantaneous rate of change and plot it against time - we get the velocity vs time relationship.
...
<div class="writein"></div>
6) The world wondered how fast he could actually run the 100m. A year later at the world championships sensors were placed along the track to capture in high resolution his position with time.
...
**Connecting to Environmental Systems**

We just looked at how Usain Bolt's speed (rate of change of position) varied during a race. Now let's think about the same ideas in an environmental context.

**A salmon swimming upstream** faces a similar analysis:

- Its **position** along the river changes over time
- Its **speed** (rate of change of position) varies — fast in open water, slow through rapids
- Its **acceleration** (rate of change of speed) tells us when it's surging or struggling

But there are many other rates of change in environmental systems that don't involve motion at all:

**Small Group Discussion:**

Pick one of the following environmental quantities and discuss how its **rate of change** might behave over time. Is the rate constant? Does it speed up or slow down? When might it be zero?

1. CO₂ concentration in the atmosphere over a year
2. Snow depth on a mountain over a winter season
3. Water level in a lake during spring snowmelt
4. The number of salmon returning to a river during a run

<div class="writein tall"></div>

**Key Takeaway:** Whether it's a sprinter on a track or carbon in the atmosphere, calculus gives us the language to describe *how fast* things change and *when* that rate itself is changing. That's the power of the derivative — and it's what this course is all about.
