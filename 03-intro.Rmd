...
![input arrow, pointing to a box with the word function in it, with an arrow leaving the box labelled output](images/In_out.png){fig.alt="Diagram of a function as an input-output machine. An arrow labeled input points into a rectangular box labeled function. An arrow labeled output exits the box on the other side, illustrating that a function takes an input value and produces an output value."}
