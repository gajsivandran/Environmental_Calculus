...
plot_ly(temp_data, x = ~time, y = ~temp, color = ~elevation, type = 'scatter', mode = 'lines') %>%
  layout(
    ...
    yaxis = list(title = "Temperature (degC)"),
...
![Figure: Quadratic function.](images/sea_level.png){fig.alt="A graph shows a downward-opening parabola representing a quadratic function. The curve rises to a maximum near x equals 2, then decreases as x increases. A dashed horizontal line marks the x-axis. The function is positive near the peak and becomes negative as it moves to the right, crossing the x-axis and continuing downward. The graph illustrates a quadratic with a single maximum point."}
